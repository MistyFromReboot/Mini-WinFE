...
Windows Forensic Environmnent - based on WinPE. This project has been developed to create a simplified method for building a Windows Forensic Environmnet (WinFE) for digital forensics acquisitions. Full documentation is included in the project download and and on the following website - 
...
WinBuilder and PEBakery version 0.9.5.1 beta5 are included in the download - please note that this version of the PEBakery has a .NET 4.7.1 dependency. 
